...
<body>
    <div class="container bg" >
        ...
        <div class="container">
        <form name="registerform" action="validate.php" onsubmit="return validate()" method="post">
        ...
        <div class="mb-3"></div>
            ...
            <p>
                ...
                <input type="text" name="lanme" id="lname" reuired minlength="4" reuired maxlength="25" class="form-control">
            </p>
            ...
            <div class="mb-3">
                ...
                <input type="pass" name="pass" id="pass" reuired class="form-control">
            </p>
        </div>
